...
return(
    ...
    <>
    {/* laptop */}
     <footer className="con1 pb-4 d-lg-flex d-none" >
  
     <div className="container ">
         <div className="footer-top d-flex justify-content-between  pt-lg-5">
  ...
  <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951"/>
        ...
        <hr/>
      <div className="footer-middle  d-flex">
        <div className="d-flex  gap-2">
        <div className="col-1-8 d-flex align-items-center gap-2">
...
<div className="hl">
         ...
         <div className="col-2-1 d-flex align-items-center gap-2">
...
<div className="hl">
         ...
         <div className="col-1-2 d-flex align-items-center gap-2">
...
<div className="hl">
   ...
   <hr className=""/>
    <div className="footer-middle ">
     ...
     {/* mobile */}
      <footer className="con1 pb-4 d-lg-none">
  
     <div className="container ">
         <div className="footer-top d-flex justify-content-between py-lg-5">
      ...
      <div className="footer-links-group mt-2">
       ...
       <div className="footer-top justify-content-between py-lg-5">
  ...
  <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951"/>
        ...
        <hr/>
      <div className="footer-middle justify-content-center pt-2 d-flex">
        <div className=" ">
        <div className="col-1-8 d-flex align-items-center gap-2">
          <p className="fp">Investors: Footer Investor
Leela Palaces Hotels & Resorts Limited (Equity)
   ...
   <hr className=""/>
    <div className="footer-middle justify-content-center">
     <div className=" d-flex gap-4 ">
        <div className="col  d-flex align-items-center gap-2 mt-2">
          <a  href="#">©2025 The Leela Palaces, Hotels and Resorts. All Rights Reserved.</a>
        </div>
