...
const Suites = () => {
    ...
    return (
        <>
            {/* <div className=" container  h-[100vh] bg-[url('/images/hotels/Manali1.jpg')] bg-cover  bg-no-repeat  bg-center">
    <Header/>
</div>
     */}


            <div className=" container Room-hero-banner">
   <div>
            ...
            <div className="container cn3 ">
                    ...
                    <div>
                        <div className="lux-heading lg:mt-0 ">
                            <div className="lg:mt-5  mt-36 ">
                                <h1 className="text-[40px] font-[400]  subpixel-antialiased mb-0">Suites </h1>
                        ...
                        <div className="container lg:px-18">
                            <div className="container roomcon ">
                ...
                {/* {laptop} */}
                <section className="w-full py-16  lg:block hidden">
                    <div className="lux-heading lg:mt-0 ">
                        <div className="lg:mt-5">
                            <h1 className="text-[40px] font-[400]  subpixel-antialiased mb-0">Standard Features </h1>
                            <span className="lux-line flex lg:justify-center">
                                {" "}
                                <img
                                    className="hrimg "
                    ...
                    <div className="mt-5  w-full mx-auto flex justify-between items-center ">

                        {/* Left Column */}
                        <div className="flex-1 text-center space-y-4">
                            <p className="text-gray-700">Internet Access</p>
                            <p className="text-gray-700">Personal Bar</p>
                            <p className="text-gray-700">King or Twin Bed</p>
                        </div>
                        ...
                        {/* Middle Column */}
                        <div className="flex-1 text-center space-y-4">
                            <p className="text-gray-700">Total Room Size of 53 sqm</p>
                            <p className="text-gray-700">Tea & Coffee Maker</p>
                            <p className="text-gray-700">24 Hour Room Service</p>
                            <p className="text-gray-700">Electronic Safe</p>
                        </div>
                        ...
                        <div className="flex-1 text-center space-y-4">
                            ...
                            <p className="text-gray-700">LED TV</p>
                            <p className="text-gray-700">110v / 220v Electrical Outlets</p>
                        </div>
                ...
                {/* {mobile} */}
                <section className="w-full py-16 lg:hidden ">
                    <div className="lux-heading lg:mt-0 ">
                        <div className="lg:mt-5 ">
                            <h1 className="text-[40px] font-[400]  subpixel-antialiased mb-0">Standard Features </h1>
                            <span className="lux-line flex lg:justify-center">
                    ...
                    <div className=" font-serif text-[1.2rem]  w-full mx-auto px-3">

                        {/* Left Column */}


                        <div className="flex gap-3">
                            <div className="w-[1%] bg-black/20  h-[16vh] ">
                        ...
                        {/* Middle Column */}
                        <div className="flex gap-3">
                            <div className="w-[1%] bg-black/20 h-[21vh] ">
                ...
                <div className=" pb-20 lg:px-18 px-3">
                    ...
                    >
                        <div className="lux-heading ">
                            <div className="">
                                <p className=" our font-[400]  subpixel-antialiased mb-0">Others Rooms and Suits </p>
                                <span className="lux-line flex lg:justify-center">
                                    {""}
                                    <img
                                        className="hrimg "
